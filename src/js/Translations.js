export default {
  en: {
    ...
    follow_someone_info:
      "Follow someone to see content from their network! Suggestion:",
    ...
    alternatively_get_sms_verified:
      "Alternatively, get <a>SMS verified</a> so others can find you.",
    ...
    otherwise_cant_log_in_again:
      "Otherwise you can't log in back to this account.",
    log_out: "Log out",
    ...
    visibility:
      "Your posts, replies and likes are only shown to your followers and their network.",
    iris_is_like:
      "Fluidi is an open source, decentralized social audio platform.",
    ...
    there_is_a_bug:
      "There's a bug that may cause high CPU and bandwidth usage when connecting to more than 1 peer. Working on it!",
    set_up_your_own_peer: "Set up your own peer",
    also: "Also",
    or_small: "or",
    automatically_load_webtorrent_attachments:
      "Automatically load webtorrent attachments",
  ...
  es: {
    ...
    profile_photo_too_big:
      "Foto de perfil demasiado grande: el tamaño máximo es de 200 KB",
    cancel: "Cancelar",
    use_photo: "Usar foto",
    ...
    save_backup_of_privkey_first:
      "¡tenga una copia de seguridad de su clave privada primero!",
    otherwise_cant_log_in_again:
  ...
  "pt-BR": {
    ...
    profile_photo_too_big:
      "Foto do perfil muito grande: tamanho máximo é 200KB",
    cancel: "Cancelar",
    use_photo: "Usar foto",
    ...
    otherwise_cant_log_in_again:
      "Caso contrário você não vai conseguir acessar sua conta novamente.",
    log_out: "Sair",
  ...
  ru: {
    ...
    logout_confirmation_info:
      "Вы <b>не сможете заново войти</b> пока не скопируете приватный ключ.",
  ...
  de: {
    ...
    beware_of_sharing_invite_link_publicly:
      "Vorsicht wenn Unterhaltung's links in der Öffentlichkeit geteilt werden: Sie können mit Nachricht Anfragen gespammt werden. Teilen sie lieber ihren <a>Profil link</a>.",
    ...
    have_someones_invite_link:
      "Haben Sie einen Unterhaltung's link von jemandem?",
    ...
    account: "Konto",
    save_backup_of_privkey_first:
      "Speichern Sie ein Backup für Ihren privaten Schlüssel!",
    otherwise_cant_log_in_again:
      "Sonst können Sie nicht mehr in Ihr Konto einloggen.",
    log_out: "Ausloggen",
    ...
    account: "Tili",
    save_backup_of_privkey_first:
      "Tallenna ensin varmuuskopio salaisesta avaimestasi!",
    otherwise_cant_log_in_again:
      "Muuten et voi kirjautua takaisin tälle tilille.",
    ...
    type_a_message_or_paste_a_magnet_link:
      "Kirjoita viesti tai liitä magnet-linkki",
    download_webtorrent:
    ...
    alternatively_get_sms_verified:
      "Vaihtoehtoisesti <a>tunnistaudu tekstiviestillä</a>",
    visibility:
      "Julkaisut, vastaukset ja tykkäykset näkyvät vain seuraajillesi ja heidän verkostoillensa.",
    no_followers_yet_info:
      "Julkaisut, vastaukset ja tykkäykset näkyvät vain seuraajillesi ja heidän verkostoillensa.",
    iris_is_like:
      "Iiris on kuin tuntemamme sosiaalisen median sovellukset, mutta parempi.",
    copy: "Kopioi",
    this_is_a_prototype_store:
    ...
    web_push_subscriptions:
      "Selaimen ilmoitustilaukset (web push subscriptions)",
    ...
    there_is_a_bug:
      "Bugin vuoksi useampaan kuin yhteen yhteyspisteeseen yhdistäminen voi kuormittaa tietokoneen suoritinta ja viedä verkkokaistaa. Korjaaminen on työn alla!",
    set_up_your_own_peer: "Pystytä oma yhteyspisteesi",
    also: "Myös",
    or_small: "tai",
    automatically_load_webtorrent_attachments:
      "Lataa webtorrentin liitteet automaattisesti",
  ...
  it: {
    ...
    profile_photo_too_big:
      "Foto di profilo troppo grande: dimensione massima di 200KB",
    cancel: "Cancella",
    use_photo: "Usa foto",
    ...
    account: "Account",
    save_backup_of_privkey_first:
      "Salva prima un backup della tua chiave privata!",
    otherwise_cant_log_in_again:
      "Altrimenti non potrai riautenticarti a questo account.",
    log_out: "Scollegati",
  ...
  "zh-cn": {
    ...
    peers_info:
      "GunDB 的节点可以帮助<a>加速连接速度 </a>。即将支持：通过 WebRTC 直接连接聊天对象。",
  ...
  ko: {
    ...
    follow_someone_info:
      "제안 그들의 네트워크의 내용을 보기위하여 펄로우 하기:",
    creator_of_this_distribution: "본Iris 배분을 위한 저작권자",
    no_followers_yet: "약력 링크를 소개하여 타인들이 펄로우 하게 함:",
    no_followers_yet_info:
      "당신의 게시, 응답, 좋아요는 당신의 펄로워 및 네트워크에 보여짐.",
    alternatively: "대안으로,",
    alternatively_get_sms_verified:
      "대안으로, 타인이 당신을 찾을 수 있도록 하기 <a>SMS 확인 </a>.",
    ...
    peers_info:
      "친구는 GunDB 노드이며 쉽게 <a>공유</a>. 향후 계획: 친구들과 직접 접속  WebRTC.",
    ...
    visibility:
      "당신의 게시물, 답변과 좋아요는 당신의 펄로워들과 네트워크에만 보여짐.",
    ...
    there_is_a_bug:
      "1명 이상의 친구와 접속하면 CPU와 통신량이 급증하는 문제가 있어 수정 하고 있음!",
    set_up_your_own_peer: "당신의 자체 친구 설정",
    also: "그리고",
    or_small: "또는",
    automatically_load_webtorrent_attachments:
      "자동적으로 webtorrent 첨부 파일 로드",
  ...
  ur: {
    ...
    follow_someone_info:
      "کسی کے حلقہ احباب کا مواد دیکھنے کے لیے اسے فالو کریں! سفارشات:",
    creator_of_this_distribution: "Iris کو بنانے والے",
    no_followers_yet:
      "اپنی پروفایٔل کو لنک شیر کریں تاکہ دوسرے آپکو فالو کر سکیں:",
    no_followers_yet_info:
      "آپکی پوسٹ ، جوابات اور پسند صرف آپکے حلقہ احباب کو دکھایٔی جاتی ہے",
    ...
    otherwise_cant_log_in_again:
      "ورنہ آپ دوبارہ اکاؤنٹ استعمال نہیں کر سکیں گے",
    log_out: "بند کریں",
    ...
    privkey_storage_recommendation:
      "پرایٔویٹ کوڈ کو رکھنے کی محفوظ جگہ <b>پاس ورڈ مینیجر ہے</b>.",
    language: "زبان",
    peers: "دوست",
    ...
    visibility:
      "آپکے پوسٹ ، جوابات اور لایٔک صرف آپکے فالورز اور انکے نیٹ ورک کو نظر آنی ہیں",
    iris_is_like:
      "Iris ہماری پسندیدہ سوشل نیٹ ورک ایپس کی طرح ہے مگر ان سے بہترہے",
    this_is_a_prototype_store:
    ...
    there_is_a_bug:
      "ایک خرابی کی وجہ سے کمپیوٹراور انٹرنیٹ کے استعمال میں اضافہ ہو سکتا ہے۔ ہم اسے درست کر رہے ہیں",
    set_up_your_own_peer: "اپنا peer سیٹ اپ کریں",
    also: "اور",
    or_small: "یا",
    automatically_load_webtorrent_attachments:
      "خود بخود webtorrent attachments لوڈ کریں",
